#!/usr/bin/env python3
"""
GEMHUB Amazon Token Refresh Script
Refreshes Amazon SP-API access token for GEMHUB account every 3500 seconds (~58 minutes)
Access tokens expire in 3600 seconds (1 hour), so we refresh before expiry.

Usage:
  python gemhub_amazon_token.py          # Run once
  python gemhub_amazon_token.py --loop   # Run continuously every 3500 seconds
"""
